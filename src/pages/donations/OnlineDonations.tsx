    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">Online Bağışlar</h2>
          <div className="flex gap-2">
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-orange-50 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-orange-600">İşlem Ücreti</h3>
            <p className="text-2xl font-bold text-orange-900">{totalFees.toLocaleString('tr-TR')} ₺</p>
          </div>
          <div className="bg-purple-50 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-purple-600">Düzenli Bağış</h3>
            <p className="text-2xl font-bold text-purple-900">{recurringCount}</p>
          </div>
        </div>

        {/* Platform Dağılımı */}
        <div className="mb-6">
          <h3 className="text-lg font-medium mb-3">Platform Dağılımı</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {platformStats.map((stat) => (
              <div key={stat.platform} className="border rounded-lg p-4">
                <h4 className="font-medium">{stat.platform}</h4>
                <p className="text-sm text-gray-600">{stat.count} bağış</p>
                <p className="text-lg font-bold">{stat.amount.toLocaleString('tr-TR')} ₺</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex gap-2">
            <button
              onClick={() => exportToCsv('online-bagislar.csv', filteredDonations)}
            ...
            <button
              onClick={() => exportDonationsToExcel(filteredDonations, { type: 'online' })}
            ...
            <button
              onClick={() => exportDonationsToPDF(filteredDonations, { type: 'online' })}
