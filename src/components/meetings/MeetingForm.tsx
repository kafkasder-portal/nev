...
export default function MeetingForm({
  ...
  const [selectedAttendees] = useState<string[]>(initialData?.attendee_ids || [])
  ...
  //     const newAttendees = [...selectedAttendees, userId]
  ...
  //   const newAttendees = selectedAttendees.filter(id => id !== userId)
  //   setSelectedAttendees(newAttendees)
  //   setValue('attendees', newAttendees)
  // }
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-2">
            {/* TODO: User selector component */}
            <div className="text-sm text-muted-foreground">
              Kullanıcı seçici bileşeni eklenecek
            </div>
            {selectedAttendees.length > 0 && (
              <div className="text-sm">
                {selectedAttendees.length} katılımcı seçildi
              </div>
            )}
          </div>
        </div>
