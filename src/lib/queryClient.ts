...
export const queryKeys = {
  ...
  institutions: {
    ...
    list: (filters: Record<string, any>) => [...queryKeys.institutions.lists(), { filters }] as const,
  ...
  messages: {
    ...
    templates: {
      ...
      list: (filters: Record<string, any>) => [...queryKeys.messages.templates.lists(), { filters }] as const,
    ...
    deliveries: {
      ...
      list: (filters: Record<string, any>) => [...queryKeys.messages.deliveries.lists(), { filters }] as const,
    },
  },
  ...
  aid: {
    ...
    applications: {
      ...
      list: (filters: Record<string, any>) => [...queryKeys.aid.applications.lists(), { filters }] as const,
    ...
    beneficiaries: {
      ...
      list: (filters: Record<string, any>) => [...queryKeys.aid.beneficiaries.lists(), { filters }] as const,
  ...
  scholarship: {
    ...
    applications: {
      ...
      list: (filters: Record<string, any>) => [...queryKeys.scholarship.applications.lists(), { filters }] as const,
    ...
    students: {
      ...
      list: (filters: Record<string, any>) => [...queryKeys.scholarship.students.lists(), { filters }] as const,
