...
export function useBeneficiarySearch(beneficiaries: any[], searchTerm: string) {
...
export function useApplicationSearch(applications: any[], searchTerm: string) {
...
export function useDonationSearch(donations: any[], searchTerm: string) {
